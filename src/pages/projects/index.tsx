...
export function ProjectListPage(props: ProjectListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProjects({
        relations: ['project_manager', 'task.count', 'team.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('project_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'project_manager',
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/project-managers/view/${record.project_manager?.id}`}
            >
              {record.project_manager?.name}
            </Link>
          ),
        }
      : null,
