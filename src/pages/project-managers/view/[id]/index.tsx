            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('project_manager', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/project-managers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="project_manager" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
